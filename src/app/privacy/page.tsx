  ...
  return (
    <div className="min-h-screen pt-24 pb-16" style={{ background: 'var(--background)' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold mb-8" style={{ color: 'var(--foreground)' }}>Privacy Policy</h1>
        <p className="mb-8" style={{ color: 'var(--foreground-muted)' }}>Last updated: {currentDate}</p>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold mb-2" style={{ color: 'var(--foreground)' }}>Your Privacy Matters</h2>
        ...
        <div className="space-y-8" style={{ color: 'var(--foreground-muted)' }}>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>2. How We Use Your Information</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>3. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--foreground)' }}>4. Data Security</h2>
            <p>
